...
const DiscordIcon: FC<IconProps> = ({ color = "currentColor", size = 50, className }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 512 512"
...
const XIcon: FC<IconProps> = ({ color = "currentColor", size = 50, className }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 640 512"
...
const YouTubeIcon: FC<IconProps> = ({ color = "currentColor", size = 50, className }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 576 512"
