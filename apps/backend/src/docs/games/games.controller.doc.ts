...
export const GamesControllerDoc = {
  ...
  Create: () => applyDecorators(
    ...
    ApiBadRequestResponse({
      description: 'Validation failed on text fields, missing required images, or unsupported image format.',
    }),
  ),
  ...
  FindAll: () => applyDecorators(
    ApiOperation({
      summary: 'List games',
      description: 'Returns a paginated list of game summaries. Public endpoint.',
    }),
  ...
  FindOne: () => applyDecorators(
    ApiOperation({
      ...
      description: 'Returns the full game detail including all fields. Public endpoint.',
    }),
    ApiParam({
      name: 'id',
      type: Number,
  ...
  Update: () => applyDecorators(
    ...
    ApiOperation({
      ...
      description: 'Admin only. All fields are optional — only send what needs to change.',
    }),
    ApiParam({
      name: 'id',
      type: Number,
  ...
  Remove: () => applyDecorators(
    ...
    ApiOperation({
      ...
      description: 'Admin only. Permanently deletes the game and cascades to related records.',
    }),
    ApiParam({
      name: 'id',
      type: Number,
