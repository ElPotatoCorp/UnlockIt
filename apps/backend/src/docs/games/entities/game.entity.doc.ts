...
import { EUAgeRating, GameType, LangCode } from 'src/games/entities/game.entity';
...
export const GameEntityDoc = {
  ...
  Slug: (required = true) => applyDecorators(
    ApiProperty({
      title: 'Slug',
  ...
  Type: (required = true) => applyDecorators(
    ApiProperty({
      title: 'Type',
  ...
  Price: (required = true) => applyDecorators(
    ApiProperty({
      title: 'Price',
  ...
  AgeRating: (required = true) => applyDecorators(
    ApiProperty({
      title: 'Age rating',
  ...
  MetacriticScore: () => applyDecorators(
    ApiProperty({
  ...
  SupportedLanguages: () => applyDecorators(
    ApiProperty({
  ...
  ReleaseDate: (required = true) => applyDecorators(
    ApiProperty({
      title: 'Release date',
      description: 'ISO 8601 date string. Can be in the future if comingSoon is true.',
      type: String,
      format: 'date',
      example: '2024-11-15',
      required: required,
  ...
  ComingSoon: (required = true) => applyDecorators(
    ApiProperty({
      title: 'Coming soon',
      description: 'Whether the game is not yet released and unavailable for purchase.',
      type: Boolean,
      example: false,
      default: false,
      required: required,
  ...
  HeaderImage: (required = true) => applyDecorators(
    ApiProperty({
      title: 'Header image',
      description: 'URL of the header image. Displayed in listings and search results.',
      type: String,
      format: 'uri',
      maxLength: 255,
  ...
  CoverImage: (required = true) => applyDecorators(
    ApiProperty({
      title: 'Cover image',
  ...
  BackgroundImage: (required = true) => applyDecorators(
    ApiProperty({
      title: 'Background image',
      description: 'URL of the background image displayed on the game detail page.',
      type: String,
      format: 'uri',
      maxLength: 255,
  ...
  ShortDescription: (required = true) => applyDecorators(
    ApiProperty({
  ...
  DetailedDescription: (required = true) => applyDecorators(
    ApiProperty({
      title: 'Detailed description',
      description: 'Full description shown on the game detail page. Supports plain text. 10–5000 characters.',
      type: String,
      minLength: 10,
      maxLength: 5000,
  ...
  PcRequirements: () => applyDecorators(
    ApiProperty({
      title: 'PC requirements',
      description: 'Plain text or structured description of minimum and recommended PC specifications.',
      type: String,
      minLength: 10,
      maxLength: 5000,
