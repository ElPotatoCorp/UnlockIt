...
export const SeriesControllerDoc = {
  ...
  Create: () => applyDecorators(
    ...
    ApiOperation({
      ...
      description: 'Admin only. Creates a new game series. Games can optionally be linked at creation time.',
    }),
  ...
  FindAll: () => applyDecorators(
    ApiOperation({
      ...
      description: 'Returns a paginated list of series with their associated games. Public endpoint.',
    }),
  ...
  FindOne: () => applyDecorators(
    ApiOperation({
      ...
      description: 'Returns a single series with its associated games. Public endpoint.',
    }),
    SERIES_ID_PARAM,
    ApiOkResponse({
  ...
  FindOneBySlug: () => applyDecorators(
    ApiOperation({
      summary: 'Get a series by slug',
      description: 'Returns a single series matched by its URL slug. Public endpoint.',
    }),
    ApiParam({
      name: 'slug',
      type: String,
  ...
  Update: () => applyDecorators(
    ...
    ApiOperation({
      ...
      description: 'Admin only. All fields are optional — only send what needs to change. To add or remove games, use the dedicated game management endpoints.',
    }),
    SERIES_ID_PARAM,
  ...
  AddGames: () => applyDecorators(
    ApiAuth(),
    ApiOperation({
      summary: 'Add games to a series',
      description: 'Admin only. Links one or more games to this series by their IDs. Already-linked games are ignored (idempotent).',
    }),
    SERIES_ID_PARAM,
    ApiBody({
  ...
  Remove: () => applyDecorators(
    ...
    ApiOperation({
      ...
      description: 'Admin only. Permanently deletes the series. Games belonging to this series will have their series_id set to null (no cascade delete on games).',
    }),
    SERIES_ID_PARAM,
    ApiNoContentResponse({
  ...
  RemoveGames: () => applyDecorators(
    ApiAuth(),
    ApiOperation({
      summary: 'Remove games from a series',
      description: 'Admin only. Unlinks one or more games from this series. Games themselves are not deleted. Already-unlinked games are ignored (idempotent).',
    }),
    SERIES_ID_PARAM,
    ApiBody({
      type: ModifyGamesInSerieDto,
