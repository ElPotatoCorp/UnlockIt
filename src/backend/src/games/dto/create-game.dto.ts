import { IsBoolean, IsDateString, IsEnum, IsNumber, IsOptional, IsString, IsUrl, Length, Max, Min } from "class-validator";
import { EUAgeRating, GameType, LangCode } from "../entities/game.entity";
...
export class CreateGameDto {
  ...
  @Type(() => Number) @IsEnum(EUAgeRating)
