...
export function Logo({ color = "white", size = 64, link, className }: LogoProps) {
    ...
    const svg = (
        ...
        >
            ...
            <path fill-rule="evenodd" clip-rule="evenodd" d="M273 12.5C274.932 12.5 276 13.567 276 15.5C276 17.433 274.933 18.5 273 18.5C271.067 18.5 270 17.433 270 15.5C270 13.567 271.067 12.5 273 12.5ZM273 14C272.172 14 271.5 14.6716 271.5 15.5C271.5 16.3284 272.172 17 273 17C273.828 17 274.5 16.3284 274.5 15.5C274.5 14.6716 273.828 14 273 14Z" fill="currentColor" />
            ...
            <path d="M274.5 72H277V76.5H270V69.5H269V73.5H264V68.5H266V60.5H271V57.5H266V59.5H259V52.5H266V49.5H263V42.5H267.5V40.5H271.5L271.5 44.5H270V48.5H274.5L274.5 72Z" fill="url(#paint1_linear_5_206)" fill-opacity="0.5" />
            <path d="M274.5 72H277V76.5H270V69.5H269V73.5H264V68.5H266V60.5H271V57.5H266V59.5H259V52.5H266V49.5H263V42.5H267.5V40.5H271.5L271.5 44.5H270V48.5H274.5L274.5 72Z" fill="url(#paint2_linear_5_206)" fill-opacity="0.2" />
            <path d="M260 74.5H256V70.5H260V74.5Z" fill="url(#paint3_linear_5_206)" />
            <path d="M260 74.5H256V70.5H260V74.5Z" fill="url(#paint4_linear_5_206)" fill-opacity="0.5" />
            <path d="M260 74.5H256V70.5H260V74.5Z" fill="url(#paint5_linear_5_206)" fill-opacity="0.2" />
            <path d="M263 67.5H259V63.5H263V67.5Z" fill="url(#paint6_linear_5_206)" />
            <path d="M263 67.5H259V63.5H263V67.5Z" fill="url(#paint7_linear_5_206)" fill-opacity="0.5" />
            <path d="M263 67.5H259V63.5H263V67.5Z" fill="url(#paint8_linear_5_206)" fill-opacity="0.2" />
            <path d="M253 66.5H250V63.5H253V66.5Z" fill="url(#paint9_linear_5_206)" />
            <path d="M253 66.5H250V63.5H253V66.5Z" fill="url(#paint10_linear_5_206)" fill-opacity="0.5" />
            <path d="M253 66.5H250V63.5H253V66.5Z" fill="url(#paint11_linear_5_206)" fill-opacity="0.2" />
            <path d="M257 60.5H252V55.5H257V60.5Z" fill="url(#paint12_linear_5_206)" />
            <path d="M257 60.5H252V55.5H257V60.5Z" fill="url(#paint13_linear_5_206)" fill-opacity="0.5" />
            <path d="M257 60.5H252V55.5H257V60.5Z" fill="url(#paint14_linear_5_206)" fill-opacity="0.2" />
            <path d="M250 52.5H246V48.5H250V52.5Z" fill="url(#paint15_linear_5_206)" />
            <path d="M250 52.5H246V48.5H250V52.5Z" fill="url(#paint16_linear_5_206)" fill-opacity="0.5" />
            <path d="M250 52.5H246V48.5H250V52.5Z" fill="url(#paint17_linear_5_206)" fill-opacity="0.2" />
            <path d="M260 49.5H255V44.5H260V49.5Z" fill="url(#paint18_linear_5_206)" />
            <path d="M260 49.5H255V44.5H260V49.5Z" fill="url(#paint19_linear_5_206)" fill-opacity="0.5" />
            <path d="M260 49.5H255V44.5H260V49.5Z" fill="url(#paint20_linear_5_206)" fill-opacity="0.2" />
            <path d="M253 42.5H249V38.5H253V42.5Z" fill="url(#paint21_linear_5_206)" />
            <path d="M253 42.5H249V38.5H253V42.5Z" fill="url(#paint22_linear_5_206)" fill-opacity="0.5" />
            <path d="M253 42.5H249V38.5H253V42.5Z" fill="url(#paint23_linear_5_206)" fill-opacity="0.2" />
            <path d="M263 39.5H259V35.5H263V39.5Z" fill="url(#paint24_linear_5_206)" />
            <path d="M263 39.5H259V35.5H263V39.5Z" fill="url(#paint25_linear_5_206)" fill-opacity="0.5" />
            <path d="M263 39.5H259V35.5H263V39.5Z" fill="url(#paint26_linear_5_206)" fill-opacity="0.2" />
            <path d="M257 32.5H254V29.5H257V32.5Z" fill="url(#paint27_linear_5_206)" />
            <path d="M257 32.5H254V29.5H257V32.5Z" fill="url(#paint28_linear_5_206)" fill-opacity="0.5" />
            <path d="M257 32.5H254V29.5H257V32.5Z" fill="url(#paint29_linear_5_206)" fill-opacity="0.2" />
            ...
            <defs>
                <linearGradient id="paint0_linear_5_206" x1="250.5" y1="26.5625" x2="277.429" y2="75.7002" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#1793D7" />
                    <stop offset="0.572115" stop-color="#1F6FEB" />
                    <stop offset="0.764423" stop-color="#00FF9F" />
                </linearGradient>
